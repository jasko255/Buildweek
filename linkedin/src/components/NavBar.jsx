...
const NavBar = () => {
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    ...
    <Nav className="ml-auto">
      ...
      <Nav.Link href="#home"><svg id="global-nav-icon--mercado__home" height="24" width="24">
    <path d="m23 9v2h-2v7c0 1.7-1.3 3-3 3h-4v-6h-4v6h-4c-1.7 0-3-1.3-3-3v-7h-2v-2l11-7z"></path>
  </svg> Home</Nav.Link>
      <Nav.Link href="#link"><svg id="global-nav-icon--mercado__my-network" height="24" width="24">
  ...
  </svg>My Network</Nav.Link>
  <Nav.Link href="#home"><svg id="global-nav-icon--mercado__jobs" height="24" width="24">
  ...
  <Nav.Link href="#home"> <svg id="global-nav-icon--mercado__messaging" height="24" width="24">
  ...
  </svg> Messaging</Nav.Link>
  <Nav.Link href="#home"> <svg id="global-nav-icon--mercado__notifications" height="24" width="24">
  ...
  <img width="24" src="https://media-exp1.licdn.com/dms/image/C4D35AQEHGgKSN6gBWg/profile-framedphoto-shrink_100_100/0/1620813541179?e=1623758400&amp;v=beta&amp;t=UIBUH3lSa6dDteZWsYAslolpQE9_0aVj5TMq8BX8NXE" height="24" alt="Janusz Kondziarz" id="ember30" className="global-nav__me-photo ember-view" />
      ...
      <span className="verticalLine d-inline">
  
  <Nav.Link href="#home"> <svg id="global-nav-icon--classic__work" height="24" width="24">
