        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Form inline className="align-items-center" style={{ height: "40px" }}>
            <Col xs="auto" className="px-0">
              <InputGroup className="flex-row mb-2">
                <InputGroup.Prepend>
                  <InputGroup.Text style={{ height: "40px", width: "40px", borderRadius: "0.25rem 0px 0px 0.25rem", backgroundColor: "White", borderRight: 0, paddingLeft: "1rem", paddingRight: "0" }}  className="mx-auto">
                    <FontAwesomeIcon style={{ height: "15px", width: "15px" }} icon={faSearch}/>
                  </InputGroup.Text>
                </InputGroup.Prepend>
                <FormControl id="inlineFormInputGroup" placeholder="Search" style={{ height: "40px", width: "300px", borderLeft: "0", paddingLeft: "0" }} className="mx-auto"/>
              </InputGroup>
            </Col>
          </Form>
          <Nav className="d-inline-flex ml-auto mt-1">
            ...
            <Nav.Link href="#home" className="flex-col text-center py-0">
              <svg id="global-nav-icon--mercado__jobs" height="40" width="40" viewBox="0 0 30 30" className="mx-4">
            ...
            <Nav.Link href="#home" className="flex-col text-center py-0"> 
            <svg id="global-nav-icon--mercado__messaging" height="40" width="40" viewBox="0 0 30 30"  className="mx-4">
            ...
            <Nav.Link href="#home" className="flex-col text-center py-0"> 
            <svg id="global-nav-icon--mercado__notifications" height="40" width="40" viewBox="0 0 30 30"  className="mx-4">
            ...
            <span className="verticalLine d-inline"> </span>
              ...
              <Nav.Link href="#home" className="flex-col text-center py-0"> 
              <svg id="global-nav-icon--classic__work" height="40" width="40" viewBox="0 0 30 30">
